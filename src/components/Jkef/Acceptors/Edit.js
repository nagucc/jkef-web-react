			...
			<div className="widget-box">
				...
				<div className="widget-body">
					<div className="widget-main">
						<Input type="text" label="姓名" ref="name" value={this.props.name} onChange={this.test.bind(this)}/>
						<Input label="手机号" ref="phone" value={this.props.phone} onChange={this.test.bind(this)}/>
						<Input type="select" label="性别" value={this.props.isMale}>
